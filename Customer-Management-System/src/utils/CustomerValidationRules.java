...
//add a method for checking dup customers
	...
	public static Customer validateAllInputs(String firstName, String lastName, String email, String password,
			double regAmount, String dob, String sub,String plan, Map<String, Customer> map) throws CustomerHandlingException {
		...
		LocalDate sub2=LocalDate.parse(sub);
		return new Customer(firstName, lastName, email, password, regAmount, dob2,sub2, validPlan);
	}
